...
REM
REM Generated by Vivado on Thu Dec 29 16:48:18 +0800 2022
...
echo "xvlog --incr --relax -L uvm -prj slti_testbench_vlog.prj"
call xvlog  --incr --relax -L uvm -prj slti_testbench_vlog.prj -log xvlog.log
