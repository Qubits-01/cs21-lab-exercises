...
REM
REM Generated by Vivado on Tue Jan 10 21:18:32 +0800 2023
...
echo "xvlog --incr --relax -L uvm -prj sra_testbench_vlog.prj"
call xvlog  --incr --relax -L uvm -prj sra_testbench_vlog.prj -log xvlog.log
