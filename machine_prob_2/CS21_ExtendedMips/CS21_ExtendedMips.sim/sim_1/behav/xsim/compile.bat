...
REM
REM Generated by Vivado on Wed Jan 11 13:49:11 +0800 2023
...
echo "xvlog --incr --relax -L uvm -prj li_testbench_vlog.prj"
call xvlog  --incr --relax -L uvm -prj li_testbench_vlog.prj -log xvlog.log
