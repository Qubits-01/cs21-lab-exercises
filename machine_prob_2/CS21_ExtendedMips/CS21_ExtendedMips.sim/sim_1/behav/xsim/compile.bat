...
REM
REM Generated by Vivado on Wed Jan 11 11:31:09 +0800 2023
...
echo "xvlog --incr --relax -L uvm -prj bgt_testbench_vlog.prj"
call xvlog  --incr --relax -L uvm -prj bgt_testbench_vlog.prj -log xvlog.log
